...
lib.ssMetadata = [
		{name:"koglejagtbutton_atlas_", frames: [[292,338,43,43],[0,501,365,7],[338,0,12,365],[174,338,116,116],[0,0,336,336],[0,338,172,161]]}
];
...
(lib.CachedBmp_5 = function() {
	this.initialize(ss["koglejagtbutton_atlas_"]);
	this.gotoAndStop(0);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	// Lag_1
	this.instance_1 = new lib.KOGLEJAGTENkogle();
	this.instance_1.setTransform(132,91);
...
p.nominalBounds = new cjs.Rectangle(27.3,256.8,388.59999999999997,7.5);
// library properties:
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/koglejagtbutton_atlas_.png", id:"koglejagtbutton_atlas_"}
	],
	preloads: []
};
